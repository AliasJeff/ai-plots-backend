...
-- Records of chart
-- ----------------------------
INSERT INTO `chart` VALUES (1690652196070334465, 'jeffery网站数据分析', 'jeffery', '日期,用户数量\n1,20\n2,40\n3,600\n', '玫瑰图', '{\n  \"tooltip\": {},\n  \"series\": [\n    {\n      \"name\": \"用户数量\",\n      \"type\": \"pie\",\n      \"data\": [\n        {\"value\": 20, \"name\": \"1\"},\n        {\"value\": 40, \"name\": \"2\"},\n        {\"value\": 600, \"name\": \"3\"}\n      ],\n      \"roseType\": \"radius\",\n      \"label\": {\n        \"show\": true,\n        \"position\": \"inside\"\n      },\n      \"emphasis\": {\n        \"itemStyle\": {\n          \"shadowBlur\": 10,\n          \"shadowOffsetX\": 0,\n          \"shadowColor\": \"rgba(0, 0, 0, 0.5)\"\n        }\n      }\n    }\n  ]\n}', '根据数据分析结果，可以看出jeffery网站的用户数量在第3天出现了显著增长，从40增加到了600。这表明在第3天有大量用户访问了该网站。前两天的用户数量相对较少，说明该网站的用户活跃度在第3天有了明显提升。', 'succeed', NULL, 1690592362125934594, '2023-08-13 17:11:09', '2023-08-13 19:17:42', 1);
INSERT INTO `chart` VALUES (1690750045223219202, '网站用户增长趋势图', '网站用户增长趋势图', '日期,用户数量\n1,20\n2,40\n3,600\n', '玫瑰图', '{\n  \"tooltip\": {},\n  \"grid\": {},\n  \"polar\": {},\n  \"angleAxis\": {\n    \"type\": \"category\",\n    \"data\": [\"1\", \"2\", \"3\"]\n  },\n  \"radiusAxis\": {},\n  \"series\": [\n    {\n      \"type\": \"bar\",\n      \"data\": [20, 40, 600],\n      \"coordinateSystem\": \"polar\",\n      \"barCategoryGap\": \"1\",\n      \"label\": {\n        \"show\": true,\n        \"position\": \"top\",\n        \"formatter\": \"{b}\\n{c}\"\n      }\n    }\n  ]\n}', '根据数据分析，网站用户数量呈现出明显的增长趋势。在第1天，用户数量为20；第2天，用户数量增加至40；第3天，用户数量激增至600。从数据中可以观察到，用户数量的增长速度非常快。根据这个趋势，可以得出结论：南城网站的用户增长非常迅速。', 'succeed', NULL, 1690592362125934594, '2023-08-13 23:39:58', '2023-08-14 18:23:53', 1);
INSERT INTO `chart` VALUES (1691017451925446658, '网站数据人数分析', '网站数据分析图', '日期,用户数量\n1,20\n2,40\n3,600\n', '雷达图', '{\n  \"title\": {\n    \"text\": \"网站数据人数分析\",\n    \"subtext\": \"用户数量\"\n  },\n  \"tooltip\": {\n    \"trigger\": \"axis\"\n  },\n  \"radar\": {\n    \"indicator\": [\n      {\n        \"name\": \"1\",\n        \"max\": 600\n      },\n      {\n        \"name\": \"2\",\n        \"max\": 600\n      },\n      {\n        \"name\": \"3\",\n        \"max\": 600\n      }\n    ]\n  },\n  \"series\": [\n    {\n      \"name\": \"用户数量\",\n      \"type\": \"radar\",\n      \"data\": [\n        {\n          \"value\": [20, 40, 600],\n          \"name\": \"用户数量\"\n        }\n      ]\n    }\n  ]\n}', '根据数据分析，龙哥网站在不同日期的用户数量呈现较大的差异。具体来说，第一天的用户数量为20人，第二天的用户数量为40人，而第三天的用户数量达到了600人。通过雷达图的可视化形式，可以直观地展示出每天的用户数量情况。从图中可以明显看出，第三天的用户数量远超过前两天，说明在第三天有一次较大规模的用户增长。这可能是由于某种推广活动或者宣传效果好所导致的。需进一步分析原因，以便针对性地进行后续的运营策略和推广活动。总体而言，龙哥网站的用户数量呈现出良好的增长态势，但仍需要不断努力提升。', 'succeed', NULL, 1690946228361175042, '2023-08-14 17:22:32', '2023-08-14 17:22:32', 0);
INSERT INTO `chart` VALUES (1691359037385428994, '我想要获取下我的网站用户增长趋势', '网站用户增长趋势图', '日期,用户数量\n1,20\n2,40\n3,600\n', '雷达图', '{\n  \"title\": {\n    \"text\": \"网站用户增长趋势\",\n    \"subtext\": \"数据来源：原始数据\"\n  },\n  \"tooltip\": {},\n  \"radar\": {\n    \"name\": {\n      \"textStyle\": {\n        \"color\": \"#fff\",\n        \"backgroundColor\": \"#999\",\n        \"borderColor\": \"#000\",\n        \"borderWidth\": 1,\n        \"borderRadius\": 3,\n        \"padding\": [3, 5]\n      }\n    },\n    \"indicator\": [\n      { \"name\": \"1\", \"max\": 600 },\n      { \"name\": \"2\", \"max\": 600 },\n      { \"name\": \"3\", \"max\": 600 }\n    ]\n  },\n  \"series\": [{\n    \"type\": \"radar\",\n    \"data\": [\n      {\n        \"name\": \"用户数量\",\n        \"value\": [20, 40, 600]\n      }\n    ]\n  }]\n}', '根据提供的原始数据，通过雷达图可以看出，在1号有20个用户，2号有40个用户，3号急剧增长到600个用户。', 'succeed', NULL, 1690946228361175042, '2023-08-15 15:59:53', '2023-08-15 15:59:53', 0);
